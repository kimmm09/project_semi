				...
				<div class="formbold-event-wrapper">
					...
					<div class="formbold-event-details">
						<h5>
							<i class='fas fa-exclamation-triangle'
								style='font-size: 20px; color: red'></i> &nbsp 회원탈퇴 전, 유의사항을 확인해
							주시기 바랍니다.
						</h5>
						...
						<ul>
							<li>유의사항 입니다 유의사항 입니다 유의사항 입니다 유의사항 입니다 유의사항 입니다 유의사항 입니다
								...
								유의사항 입니다 유의사항 입니다 유의사항 입니다 유의사항 입니다 유의사항 입니다 유의사항 입니다 유의사항 입니다</li>
						</ul>
					</div>
					...
					<div class="formbold-event-details">
						<h5>
							...
							&nbsp 회원탈퇴 사유를 선택해 주시기 바랍니다.
						</h5>
						<ol>
							<div class="formbold-mb-5">
								<div class="formbold-radio-flex">
									<div class="formbold-radio-group">
										<label class="formbold-radio-label"> <input
											class="formbold-input-radio" type="radio" name="qusOne"
											id="qusOne" /> 회원탈퇴 사유 1 <span
											class="formbold-radio-checkmark"></span>
										</label>
									</div>
